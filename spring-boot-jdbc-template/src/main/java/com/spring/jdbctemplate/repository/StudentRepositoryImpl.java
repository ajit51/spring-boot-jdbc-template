...
public class StudentRepositoryImpl implements StudentRepository {
	...
	public int addStudent(Student student) {
		...
		return jdbcTemplate.update(insertQuery, student.getId(), student.getName(), student.getContactNumber(),
				student.getAddress());
	}
	...
	public List<Student> getAllStudents() {
		...
		List<Student> allStudentsList = jdbcTemplate.query(selectAllQuery,
	...
	public Student getStudentById(int id) {
		...
		Student student = jdbcTemplate.queryForObject(selectByIdQuery, BeanPropertyRowMapper.newInstance(Student.class),
				id);
		return student;
	}
	...
	public int updateStudent(Student student) {
		...
		return jdbcTemplate.update(updateQuery, student.getId(), student.getName(), student.getContactNumber(),
